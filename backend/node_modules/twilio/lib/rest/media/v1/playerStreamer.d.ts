...
import V1 = require('twilio/lib/rest/media/V1');
import { PlaybackGrantList } from 'twilio/lib/rest/media/v1/playerStreamer/playbackGrant';
import { PlaybackGrantListInstance } from 'twilio/lib/rest/media/v1/playerStreamer/playbackGrant';
