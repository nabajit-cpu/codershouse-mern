...
import FlexApi = require('twilio/lib/rest/FlexApi');
import Version = require('twilio/lib/base/Version');
import { ChannelList } from 'twilio/lib/rest/flexApi/v1/channel';
import { ChannelListInstance } from 'twilio/lib/rest/flexApi/v1/channel';
import { ConfigurationList } from 'twilio/lib/rest/flexApi/v1/configuration';
import { ConfigurationListInstance } from 'twilio/lib/rest/flexApi/v1/configuration';
import { FlexFlowList } from 'twilio/lib/rest/flexApi/v1/flexFlow';
import { FlexFlowListInstance } from 'twilio/lib/rest/flexApi/v1/flexFlow';
import { WebChannelList } from 'twilio/lib/rest/flexApi/v1/webChannel';
